  ...
  <div class="content container">
              <div class="page-wrapper">
                  <header class="page-heading clearfix">
                      ...
                      <a class="btn btn-theme read-more float-right" href="/manage/grupo/create">Nuevo grupo<i class="fas fa-chevron-right"></i></a>
                  </header>
                            ...
                            @foreach ($grupos as $grupo)
                              <article class="news-item page-row has-divider clearfix row">
                                  ...
                                  <div class="details col-lg-10 col-md-9 col-8">
                                      <h3 class="title"><a href="news-single.html">{{$grupo->nombre_grupo}}</a></h3>
                                      <p>{{$grupo->descripcion_grupo}}</p>
                                      <a class="btn btn-theme read-more" href="/manage/grupo/{{$grupo->id}}">Editar<i class="fas fa-chevron-right"></i></a>
                                  </div>
                              </article>
                            @endforeach
