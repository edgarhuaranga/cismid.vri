  ...
  <div class="content container">
              <div class="page-wrapper">
                  <header class="page-heading clearfix">
                      <h1 class="heading-title float-left">Miembros</h1>
                      ...
                      <div class="row page-row">
                          <div class="news-wrapper col-lg-8 col-md-7">
                            ...
                            <article class="contact-form col-lg-8 col-md-7  col-12 page-row">
                                <h3 class="title">Nuevo miembro</h3>
                                ...
                                <form method="post" action="/manage/grupos/{grupos}/miembros">
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group email">
                                        ...
                                        <textarea name="interes_miembro" rows="8" cols="80"></textarea>
                                    </div><!--//form-group-->
