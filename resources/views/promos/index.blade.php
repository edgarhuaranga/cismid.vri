  ...
  <div class="content container">
              <div class="page-wrapper">
                  <header class="page-heading clearfix">
                      ...
                      <a class="btn btn-theme read-more float-right" href="/manage/promos/create">Nueva promo<i class="fas fa-chevron-right"></i></a>
                  </header>
                            ...
                            @foreach ($promos as $promo)
                              <article class="news-item page-row has-divider clearfix row">
                                  ...
                                  <div class="details col-lg-10 col-md-9 col-8">
                                      <h3 class="title"><a href="news-single.html">{{$promo->texto_principal}}</a></h3>
                                      <p>{{$promo->texto_secundario}}</p>
                                      <a class="btn btn-theme read-more">Editar<i class="fas fa-chevron-right"></i></a>
                                  </div>
                              </article>
                            @endforeach
