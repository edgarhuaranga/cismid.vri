  ...
  <div class="content container">
              <div class="page-wrapper">
                  <header class="page-heading clearfix">
                      <h1 class="heading-title float-left">Promos</h1>
                  </header>
                      ...
                      <div class="row page-row">
                          <div class="news-wrapper col-lg-8 col-md-7">
                            ...
                            <article class="contact-form col-lg-8 col-md-7  col-12 page-row">
                                <h3 class="title">Crear promoción</h3>
                                ...
                                <form method="post" action="/manage/promos">
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group email">
                                        <label >Subtitulo<span class="required">*</span></label>
                                        <textarea name="texto_secundario" rows="8" cols="80"></textarea>
                                    </div><!--//form-group-->
                                    <div class="form-group phone">
                                        <label>Imagen URL</label>
                                        <input type="text" class="form-control" name="path_imagen">
                                    </div><!--//form-group-->

                                    <button type="submit" class="btn btn-theme">Crear promo</button>
                                </form>
